...
/* harmony import */ var waypoints_lib_noframework_waypoints_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! waypoints/lib/noframework.waypoints.js */ "./node_modules/waypoints/lib/noframework.waypoints.js");
/* harmony import */ var waypoints_lib_noframework_waypoints_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(waypoints_lib_noframework_waypoints_js__WEBPACK_IMPORTED_MODULE_3__);
...
aos__WEBPACK_IMPORTED_MODULE_2___default().init({}); // $('.startgomb').on("click", function(e) {
...
function poscheck() {
  leadbasebottom = window.innerHeight - (jquery__WEBPACK_IMPORTED_MODULE_0___default()('.thelead').offset().top + jquery__WEBPACK_IMPORTED_MODULE_0___default()('.thelead').height());
}
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).on('scroll', function () {
  ...
  if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() === 0) {
    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.banner').css('transform', 'translate3d(0, 0, 0)');
    poscheck();
  } else if (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() - leadbasebottom > 0 && jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() - leadbasebottom <= window.innerHeight && window.innerHeight + jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() > 0) {
    var ytolas = 0 - (jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop() - leadbasebottom); // console.log('itt kell ügyeskedni' + ytolas + 'px');

    jquery__WEBPACK_IMPORTED_MODULE_0___default()('.banner').css('transform', 'translate3d(0,' + ytolas + 'px, 0)'); // $('.banner').css('bottom', ytolas +'px')
  }
});
}();
/******/ })()
